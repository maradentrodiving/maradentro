...
export default () => (
  <>
    ...
    <p>
      Five different scenarios, five dives in which you’ll face something new. Go a little deeper, dive at night, glide on a current … No doubt, a course attractive like few others.
    </p>
    ...
    <h2>What does it take to get started?</h2>
    ...
    <p>
      <strong>Price:</strong> ${prices.aow}.
    </p>
  </>
)
